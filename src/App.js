          ...
          <div className="container col-xxl-8 px-4 pt-5">
            <div className="row flex-lg-row-reverse align-items-center g-5 pt-5">
              ...
              <div className="col-lg-6">
                ...
                <h3 className="display-8  mb-3">Full Stack Developer</h3>

                <div className="d-grid gap-2 d-md-flex justify-content-md-start mt-4">
                  <button type="button" className="btn btn-light btn-lg px-4 me-md-2"><svg xmlns="http://www.w3.org/2000/svg"
                    width="16" height="16" fill="currentColor" className="bi bi-apple mb-1" viewBox="0 0 16 16">
                    <path
                  ...
                  <button type="button" className="btn btn-outline-light btn-lg px-4"><svg xmlns="http://www.w3.org/2000/svg"
                    width="16" height="16" fill="currentColor" className="bi bi-google-play mb-1" viewBox="0 0 16 16">
                    <path
          ...
          <div className="container mt-5">
            <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
              <div className="col d-flex align-items-start">
                ...
                <div>
                  <h3 className="fs-2">PasteBin.</h3>
                  <p>FullStack App involving CRUD properties.</p>
              ...
              <div className="col d-flex align-items-start">
                <div
                  className="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
                  <svg xmlns="http://www.w3.org/2000/svg" height="30" fill="currentColor" className="bi bi-mortarboard"
                    viewBox="0 0 16 16">
                    <path
                ...
                <div>
                  <h3 className="fs-2">NBA App.</h3>
                  <p>Front-end app utilising API.</p>
              ...
              <div className="col d-flex align-items-start">
                ...
                <div>
                  <h3 className="fs-2">TFL App.</h3>
                  <p>Get the latest Bus times and arrivals.</p>
        ...
        <section id="pricing">
          <div className="container">
            <div className="pricing-header p-3 pb-md-4 mx-auto text-center">
              <h2 className="display-4 fw-normal">List of a few applications I have built</h2>
              <p className="fs-5 text-body-secondary">Showcasing some of the skills I have developed over the years.</p>
            </div>
            <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
              <div className="col">
                <div className="card mb-4 rounded-3 shadow-sm">
                  <div className="card-header py-3">
                    <h4 className="my-0 fw-normal">PasteBin</h4>
                  </div>
                  <div className="card-body">
                    <h1 className="card-title pricing-card-title"><small className="text-body-secondary fw-light"></small></h1>
              ...
              <div className="col">
                <div className="card mb-4 rounded-3 shadow-sm">
                  <div className="card-header py-3">
                    <h4 className="my-0 fw-normal">TFL Lines</h4>
                  </div>
                  <div className="card-body">
                    <ul className="list-unstyled mt-3 mb-4">
              ...
              <div className="col">
                <div className="card mb-4 rounded-3 shadow-sm border-dark">
                  <div className="card-header py-3 border-dark">
                    <h4 className="my-0 fw-normal">NBA</h4>
                  </div>
                  <div className="card-body">
